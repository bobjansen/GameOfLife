...
demo_grid =  GameOfLife(4,8).create_starter_grid([[1,4],[2,3],[2,4]]) # equal to example
...
def test_cycle():
    grid = GameOfLife(4,8).create_starter_grid([[0,0],[0,1],[0,2],[1,0],[1,1]])
    expected = \
""" *.*.....
    ***.....
    ........
...
""" ........
    ...
    ...**...
    ........""".replace(' ','')
    assert GameOfLife.cycle(grid).format_grid() == expected

def test_final_board():
    grid =  GameOfLife(4,8).create_starter_grid([[0,0],[1,0],[2,0],[3,0],[2,1],[2,2],[2,3],[2,4],[2,5],[2,6],[2,7]])
    expected = \
""" ........
    ........
    ........
    ........""".replace(' ','')
    assert GameOfLife.final_board(grid,100).format_grid() == expected